...
function install_artifact () {
    ...
    mvn install:install-file -DgroupId="$1" -DartifactId="$2" -Dversion="$3"
        -Dfile="$4" -Dpackaging=jar -DgeneratePom=true
}
...
if [ -r "${R}/com/google/gdata/gdata-core/1.0/gdata-core-1.0.jar" ] || \
   [ -r "${R}/com/google/gdata/gdata-spreadsheet/3.0/gdata-spreadsheet-3.0.jar" ];
then
